...
{
  "pkgs":[
  "nano","curl","sudo","mariadb103-server","redis","php72-ctype",
...
iocage exec ${JAIL_NAME} su -m www -c 'php /usr/local/www/apache24/data/nextcloud/occ config:system:set redis timeout --value=1 --type=integer'
